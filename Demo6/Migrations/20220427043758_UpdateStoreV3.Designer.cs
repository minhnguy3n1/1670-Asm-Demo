...
namespace Demo6.Migrations
{
    ...
    [Migration("20220427043758_UpdateStoreV3")]
    partial class UpdateStoreV3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Demo6.Areas.Identity.Data.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Demo6.Models.Category", b =>
                {
                    b.Property<int>("CategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Demo6.Models.Book", b =>
                {
                    b.HasOne("Demo6.Models.Category", "Category")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("Demo6.Models.Cart", b =>
                {
                    ...
                    b.HasOne("Demo6.Areas.Identity.Data.AppUser", "User")
                        .WithOne("Cart")
                        .HasForeignKey("Demo6.Models.Cart", "UId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Demo6.Areas.Identity.Data.AppUser", null)
                        .WithMany()
